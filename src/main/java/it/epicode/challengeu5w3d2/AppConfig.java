package it.epicode.challengeu5w3d2;
...
public class AppConfig {
    //questo serve per creare un oggetto cloudinary che ci permette di
    //uploadare file , Va creata una mappa con all'interno
    //le proprietà per accedere al servizio e poi questa mapppa
    //va passata al costruttore di cloduinary per istanziarlo
